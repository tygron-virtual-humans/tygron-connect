...
For this release of the environment we decided to have three sorts of buildings that the agent can build: parking spaces, parks and buildings. We decided to do this because we have limited time; the Virtual Human will only play in a map where the only goals that can be accomplished involves building these buildings.
\end{document}
